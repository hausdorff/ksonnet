...
func Init(name string, rootPath AbsPath, spec ClusterSpec, context, serverURI, namespace *string) (Manager, error) {
	...
	return initManager(name, rootPath, spec, context, serverURI, namespace, gh, appFS)
}
